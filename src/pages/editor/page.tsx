            ...
            <div className="flex-1 flex overflow-hidden">
                ...
                <div className="w-1/2 md:w-[45%] lg:w-[40%] border-r bg-card h-full flex flex-col">
                    <Tabs defaultValue="form" className="flex-1 flex flex-col">
                        ...
                        {/* JSON Editor Tab */}
                        <TabsContent value="json" className="flex-1 overflow-hidden m-0 flex flex-col p-6 space-y-6">
                            ...
                            <div className="flex-1 flex flex-col min-h-0 space-y-2">
                                <Label htmlFor="json-paste" className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">
